...
Índice da documentação do projeto. Comece pela [Visão Geral](visao-geral.md).

## Índice

| Documento | Conteúdo |
|-----------|----------|
| [Visão Geral](visao-geral.md) | Problema, proposta de valor e perfil do usuário |
| [Personas](personas.md) | Mateus (Engenharia), Camila (Gestão) e Alejandro (Design) — V3 |
...
| [Setup Local](setup.md) | Como rodar o projeto localmente e deploy |
| [Roadmap & Entregáveis](roadmap.md) | Escopo do MVP, opcionais e cronograma |
| [Referências Culturais](referencias.md) | Filmes e livros que inspiram a proposta |
| [Contribuindo](contribuindo.md) | Fluxo de trabalho da equipe |
